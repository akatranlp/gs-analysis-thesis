...
Ein Hardware-Server kann, genau wie ein VM-Server acuh direkt einen Gameserver hosten. In diesem Fall haben beide eine Dockerhost-Instanz, die die Dockerverbindung verwaltet und wodurch dann die Gameserver gestartet und gestoppt werden können.
